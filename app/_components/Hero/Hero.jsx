...
function Hero() {
  return (
    <section className='hero-container pt-12 pb-24'>
      ...
      >
        <h2 className="text-3xl font-bold mb-4 text-slate-100">Hi, I'm Chandra <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-400">Dev</span> Yadav</h2>
